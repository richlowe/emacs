  ...
  (let*
	...
	(when light-checkout
	  (when (string-match ".+checkout of branch: \\(.+\\)$" str)
	    (match-string 1 str)))))
    (concat
     (propertize "Parent branch      : " 'face 'vc-dir-header-name-face)
     (propertize
     ...
     "\n"
      (when light-checkout
	(concat
	 (propertize "Light checkout root: " 'face 'vc-dir-header-name-face)
	 (propertize light-checkout 'face 'vc-dir-header-value-face)
	 "\n"))
      (when light-checkout-branch
	(concat
	 (propertize "Checkout of branch : " 'face 'vc-dir-header-name-face)
	 (propertize light-checkout-branch 'face 'vc-dir-header-value-face)
	 "\n"))
      (when pending-merge
	(concat
	 ...
	 "\n"))
	  ...
	  (concat
	   ...
	   (mapconcat
	    ...
	    shelve "\n"))
	(concat
	 (propertize "Shelves            : " 'face 'vc-dir-header-name-face
		     'help-echo shelve-help-echo)
